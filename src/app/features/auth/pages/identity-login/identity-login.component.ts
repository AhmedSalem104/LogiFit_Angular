...
@Component({
  ...
  `,
  styles: [`:host{display:block;min-width:0;max-width:100%}.identity-flow{width:100%;min-width:0;max-width:100%;overflow-wrap:anywhere;color:var(--text-primary)}header{text-align:center;margin-bottom:1.35rem}header.compact{text-align:start}.brand-mark{display:grid;place-items:center;width:48px;height:48px;margin:0 auto .7rem;border-radius:16px;background:linear-gradient(135deg,#2563eb,#7c3aed);color:#fff;font-size:1.25rem}.eyebrow{margin:0 0 .25rem;color:#2563eb;font-size:.72rem;font-weight:900;letter-spacing:.08em;text-transform:uppercase}h1{margin:0;font-size:clamp(1.4rem,5vw,1.75rem);line-height:1.35;overflow-wrap:anywhere}header p:not(.eyebrow){margin:.45rem 0 0;color:var(--text-secondary);line-height:1.7;overflow-wrap:anywhere}form{display:grid;gap:.55rem;min-width:0}label{margin-top:.25rem;font-size:.86rem;font-weight:800}.input-shell{position:relative;display:flex;align-items:center;min-width:0}.input-shell>i{position:absolute;right:.9rem;color:var(--text-muted)}.input-shell input{width:100%;min-width:0;box-sizing:border-box;min-height:48px;padding:.75rem 2.6rem;border:1px solid var(--border-color);border-radius:10px;background:var(--bg-primary);color:var(--text-primary);font:inherit}.input-action{position:absolute;left:.55rem;border:0;background:transparent;color:var(--text-muted);cursor:pointer}.field-error,.error{margin:.15rem 0;color:#b91c1c;font-size:.82rem;overflow-wrap:anywhere}.error{display:flex;align-items:center;gap:.4rem;padding:.7rem;border-radius:9px;background:#fef2f2}.primary{display:flex;align-items:center;justify-content:center;gap:.45rem;width:100%;min-height:48px;margin-top:.75rem;border:0;border-radius:10px;background:linear-gradient(135deg,#2563eb,#4f46e5);color:#fff;font:inherit;font-weight:800;cursor:pointer}.primary:disabled{opacity:.55;cursor:not-allowed}.security-note{margin-top:1.4rem;text-align:center;color:var(--text-secondary);font-size:.78rem;overflow-wrap:anywhere}.section-title{margin:1.2rem 0 .55rem;font-size:.92rem}.cards{display:grid;gap:.6rem;min-width:0}.choice-card{display:flex;align-items:center;gap:.75rem;width:100%;min-width:0;padding:.85rem;border:1px solid var(--border-color);border-radius:12px;background:var(--bg-primary);color:var(--text-primary);text-align:start;cursor:pointer}.choice-card:disabled{opacity:.6}.workspace-icon{display:grid;place-items:center;flex:0 0 40px;height:40px;border-radius:12px;background:#eff6ff;color:#2563eb}.pending .workspace-icon{background:#fff7ed;color:#b45309}.pending-freelance{border-color:#ddd6fe}.pending-freelance .workspace-icon{background:#f5f3ff;color:#7c3aed}.pending-gym{border-color:#bfdbfe}.pending-message{display:block;color:var(--text-primary);font-size:.76rem;line-height:1.5}.choice-copy em{display:block;color:#64748b;font-size:.7rem;font-style:normal;overflow-wrap:anywhere}.choice-copy{display:grid;gap:.15rem;flex:1;min-width:0}.choice-copy b,.choice-copy small{overflow-wrap:anywhere}.choice-copy small{color:var(--text-secondary)}.text-button{border:0;background:transparent;color:#2563eb;padding:.65rem 0 0;font:inherit;cursor:pointer}`],
})
