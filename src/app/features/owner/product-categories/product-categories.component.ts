  ...
  template: `
    <div class="gym-page">
      ...
      <div class="state-card error-state" *ngIf="!loading() && errorMessage()" role="alert">
        ...
        <div><strong>تعذر تحميل فئات المنتجات</strong><p>{{ errorMessage() }}</p>
...
export class ProductCategoriesComponent implements OnInit {
  ...
  load() {
    ...
    this.svc.listProductCategories().subscribe({
      ...
      error: () => {
        this.errorMessage.set('تعذر الاتصال بخدمة فئات المنتجات. تحقق من اتصال الخادم ثم أعد المحاولة.');
