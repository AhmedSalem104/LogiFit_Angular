...
- أثناء تحميل الخطط: يؤجل زر «اشتراك جديد» فتح النموذج ويفتحه تلقائياً بعد وصول الخطط.
- لا توجد خطط: تعرض الشاشة حالة واضحة وتطلب إنشاء خطة من `/owner/subscription-plans`، ويحوّل الزر إليها مباشرة.
- لا يوجد عملاء: يفتح النموذج مباشرة في وضع «عميل جديد».
- بيانات ناقصة: تمنع الواجهة الإرسال وتوضح الحقول المطلوبة.
- هاتف أو بريد مكرر أو اشتراك متداخل: يعرض الخادم رسالة تعارض ولا ينشئ سجلاً مكرراً.
